# Added Airport > icaoCode property.

[All additions](README.md) · [Growth explorer](../../schemaorg-growth.html)

First observed source declaration: 2014-05-22. Recorded commit author: **Vicki Tardif Holland**. [Commit](https://github.com/schemaorg/schemaorg/commit/859da30735808be4aab15161536b6a6b34cbd0e9).

<a id="term-icaoCode"></a>
## icaoCode

Property · current · [Schema.org](https://schema.org/icaoCode)
